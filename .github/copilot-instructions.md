...
- **Private fields that need to be serialized in the Unity Inspector must use the underscore prefix with camelCase and be marked with `[SerializeField]` (e.g., `[SerializeField] private int _mySerializedField;`)**
